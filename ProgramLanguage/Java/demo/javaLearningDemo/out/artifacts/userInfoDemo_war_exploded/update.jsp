...
<div class="container" style="width: 400px;">
    <h3 style="text-align: center;">修改联系人</h3><!-- 根据request域中的user信息，回显信息 -->
    <form action="${pageContext.request.contextPath}/UpdateUserServlet" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="password" name="password"  value="${updateUser.password}" readonly="readonly" placeholder="请输入密码" />
        </div>
        <div class="form-group">
            <label>性别：</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="${updateUser.age}" id="age"  name="age" placeholder="请输入年龄" />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="qq" class="form-control" value="${updateUser.qq}" name="qq" placeholder="请输入QQ号码"/>
        </div>
