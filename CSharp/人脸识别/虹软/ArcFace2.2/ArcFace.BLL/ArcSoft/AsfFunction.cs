...
namespace ArcFace.BLL
{
    ...
    {
        private const string DllPath = @"E:\Work\ArcSoft人脸识别\ArcFace2.2\ArcFace.Base\refDLL\ArcSoft\libarcsoft_face_engine.dll";
        /// <summary>
        /// 激活SDK（激活一次即可）
        /// </summary>
        ...
        public static extern int ASFDetectFaces(IntPtr pEngine, int width, int height, int format, IntPtr imgData, out AsfStruct.ASF_MultiFaceInfo faceInfo);
        ...
        public static extern int ASFFaceFeatureExtract(IntPtr pEngine, int width, int height, int format, IntPtr imgData, ref AsfStruct.ASF_SingleFaceInfo faceInfo, out AsfStruct.ASF_FaceFeature faceFeature);
        ...
        public static extern int ASFFaceFeatureCompare(IntPtr pEngine, ref AsfStruct.ASF_FaceFeature faceFeature1, ref AsfStruct.ASF_FaceFeature faceFeature2, out float confidenceLevel);
