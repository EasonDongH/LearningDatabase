...
namespace ArcFace.Models
{
    ...
    public class AsfConstants
    {
        ...
        /// 调用正确码
        /// </summary>
        public const int MOK = 0;

        /// <summary>
        /// 人脸识别模式
        /// </summary>
        public class AsfFaceDetectMode
        {
            /// <summary>
            /// Video模式，一般用于多帧连续检测
            /// </summary>
        ...
        /// 调用类型mask
        /// </summary>
        public class AsfFaceFunction
        {
            public const uint NONE = 0x00000000;
            /// <summary>
            /// 人脸检测 此处detect可以是tracking或者detection两个引擎之一，具体的选择由detect mode 确定
            /// </summary>
            public const uint ASF_FACE_DETECT = 0x00000001;

            /// <summary>
            /// 人脸识别
            /// </summary>
            public const uint ASF_FACE_RECOGNITION = 0x00000004;

            /// <summary>
            /// 年龄检测
            /// </summary>
            public const uint ASF_FACE_AGE = 0x00000008;

            /// <summary>
            /// 性别检测
            /// </summary>
            public const uint ASF_FACE_GENDER = 0x00000010;

            /// <summary>
            /// 人脸角度检测
            /// </summary>
            public const uint ASF_FACE_3DANGLE = 0x00000020;
        }

        /// <summary>
        /// 颜色空间格式模式
        /// </summary>
        public class AsfFacePixelFormat
        {
