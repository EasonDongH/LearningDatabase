...
namespace ArcSoft.Face
{
    public class ASFAPI
    {
        private const string DllPath = @"ArcSoftFace\libarcsoft_face_engine.dll";
        ...
        /// <param name="detectFaceMaxNum">最大检测人脸的个数[2,50]</param>
        ...
        public static extern int ASFFaceFeatureCompare(IntPtr hEngine,ref FaceFeature feature1,ref FaceFeature feature2, ref float confidenceLevel);
        ...
        public static extern int ASFProcess(IntPtr hEngine, int width, int height, int format, byte[] imgData, ref MultiFaceInfo detectedFaces, int combinedMask);
        ...
        public static extern int ASFGetLivenessScore(IntPtr hEngine, ref LivenessInfo livenessInfo);
