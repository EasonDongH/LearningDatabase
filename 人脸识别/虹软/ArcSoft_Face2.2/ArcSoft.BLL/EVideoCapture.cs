...
namespace ArcSoft.BLL
{
    public class EVideoCapture : IDisposable
    {
        ...
        public event GrabbedFrameHandler GrabbedFrame;
        ...
        public EVideoCapture(int index, bool isMirror)
        {
        ...
        public EVideoCapture(string fileName, bool isMirror)
        {
